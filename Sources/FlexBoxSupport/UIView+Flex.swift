...
// 定义泛型协议
public protocol BoxKitCompatible {
    associatedtype CompatibleType
    var box: CompatibleType { get }
}

// 协议的扩展
public extension BoxKitCompatible {
    var box: BoxKit<Self>{
        get { return BoxKit(self) }
    }
}

extension UIResponder: BoxKitCompatible {}

extension BoxKit where Base: UIView {
