...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FlexBoxSupport.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ljk/FlexBoxSupport'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ljk' => 'liujk0723@gmail.com' }
  s.source           = { :git => 'https://github.com/ljk/FlexBoxSupport.git', :tag => s.version.to_s }
